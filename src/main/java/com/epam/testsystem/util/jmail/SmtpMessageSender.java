...
//Class to control sending post messages to certain user
    ...
    public MimeMessage addAttachment(MimeMessage message, File file) throws IOException, MessagingException {
